    ...
    >
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 gap-8">
        ...
        <div className="hidden lg:flex h-1/2 lg:h-full md:w-1/2 relative">
          <Image src="/laptop.jpg" alt="Laptop Image" fill className="object-contain rounded-2xl" sizes="(max-width: 768px) 300px, (max-width: 1200px) 400px" blurDataURL="/laptop.jpg" placeholder="blur"/>
        </div>
        {/* TEXT CONTAINER */}
        <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 justify-center text-center lg:text-left pt-40 sm:pt-16 lg:pt-0">
          ...
          <h1 className="text-2xl md:text-4xl font-bold">
            ...
            <Typical
              steps={['Websites', 1000, 'Landing Pages', 1000, 'Web Apps', 1000]}
              loop={Infinity}
              wrapper="p"
          ...
          <p className="md:text-xl">
            I take pride in creating user-friendly and elegant projects.
            My attention to detail means that I go above and beyond to deliver products that fulfil my clients&apos; needs and requirements.
          </p>
          {/* BUTTONS */}
